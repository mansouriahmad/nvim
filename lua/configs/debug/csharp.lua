...
M.get_csharp_debug_info = function()
...
M.build_csharp_project = function(project_info, callback)
...
M.setup_configurations = function(dap, get_csharp_debug_info)
